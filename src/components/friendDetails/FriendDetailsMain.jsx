...
const FriendDetailsMain = ({picture,name,status,tags,bio,email}) => {
    return (
        <div className='space-y-4 bg-base-100 rounded-2xl p-6 text-center shadow hover:shadow-xl hover:shadow-[#378368] hover:scale-101 transition-all duration-300'>
                    ...
                    <p className='text-[14px] text-gray-400'>Email: {email}</p>
                </div>
    );
};
