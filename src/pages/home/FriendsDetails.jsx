    ...
    return (
        <div className='bg-base-200 py-20'>
            <div className='container mx-auto grid grid-cols-3 md:grid-cols-5  gap-6'>
                ...
                <div className='shadow hover:shadow-xl hover:shadow-[#244D3F] hover:scale-101 transition-all duration-300  space-y-2 bg-base-100 rounded-2xl text-center flex justify-center items-center py-8 px-4 col-span-3 md:col-span-1' >
                    <div>
