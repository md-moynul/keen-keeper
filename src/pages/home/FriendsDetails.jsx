        ...
        <div className='bg-base-200 py-20'>
            <div className='container mx-auto grid grid-cols-3 md:grid-cols-5  gap-6'>
                <div className='col-span-3 md:col-span-2 row-span-3 space-y-6'>
                    <FriendDetailsMain name={name} picture={picture} tags={tags} status={status} bio={bio} preferred_contact_method={preferred_contact_method} email={email} />
                    <div className='col-span-3 md:col-span-2 '>
                        <SnoozeArchiveDelete />
                    </div>
                </div>
                <div className='shadow hover:shadow-xl hover:shadow-[#378368] hover:scale-101 transition-all duration-300  space-y-2 bg-base-100 rounded-2xl text-center flex justify-center items-center py-8 px-4 col-span-3 md:col-span-1' >
                    <div>
                ...
                <div className='col-span-3  bg-base-100 rounded-2xl pt-8 shadow hover:shadow-xl hover:shadow-[#378368] hover:scale-101 transition-all duration-300'>
                    <Goal goal={goal} />
                </div>
